...
- **Globals** appear in their own column at the top. They are filled once and applied to every row in the list. Source columns only map to regular variable names — not to global ones.
